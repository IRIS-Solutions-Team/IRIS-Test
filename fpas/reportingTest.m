...
% just close all figures
close all;
end


function testGenerateEmptyReport(this)
% generate report
...
function testUserFigureReport(this)
% load data
...
function testRegularLineFigureReport(this)
% load data
rngPlot = this.TestData.rngPlot;
hlight = this.TestData.hlight;
...
function testLineAndConbarFigureReport(this)
% load data
rngPlot = this.TestData.rngPlot;
hlight = this.TestData.hlight;
sty = this.TestData.sty;
...
function testShortTableReport(this)
% load data
hlight = this.TestData.hlight;
db = this.TestData.db;
...
function testLongTableReport(this)
% load data
hlight = this.TestData.hlight;
db = this.TestData.db;
