...
profile clear;
profile on;
pEst3 = estimate(m3, d, range, est, 'Steady', true, 'Display', 'off', 'summary', 'struct');
stats = profile('info');
...
profile clear;
profile on;
pEst1 = estimate(m1, d, range, est, 'Display', 'off', 'summary', 'struct');
stats = profile('info');
...
profile clear;
profile on;
pEst2 = estimate(m2, d, range, est, 'Steady', true, 'Display', 'off', 'summary', 'struct');
stats = profile('info');
