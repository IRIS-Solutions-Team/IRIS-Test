...
[db.eu_gdp31, info31] = genip( ...
    db.eu_gdp_yearly, Frequency.QUARTERLY, 'Rate', @sum ...
    , 'Range=', startInterp:endInterp ...
    , 'Indicator.Level=', [db.ge_gdp, db.fr_gdp] ...
    , 'Indicator.StdScale=', [1e-5, 1e-3] ...
);

[db.eu_gdp32, info32] = genip( ...
    db.eu_gdp_yearly, Frequency.QUARTERLY, 'Rate', @sum ...
    , 'Range=', startInterp:endInterp ...
    , 'Indicator.Level=', [db.ge_gdp, db.fr_gdp] ...
    , 'Indicator.StdScale=', [1e-3, 1e-5] ...
);
return
