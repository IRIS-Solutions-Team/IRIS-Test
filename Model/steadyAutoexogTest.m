...
m.y = 1.05*m.y;
m.k = 0.95*m.k;
m1 = steady(m, 'exogenize', @auto, 'endogenize', @auto, 'display', 'none');

m2 = m;
m2.del = m1.del;
m2.alp = m1.alp;
m2 = steady(m2, 'display', 'none');

compareModels(m1, m2);

m3 = steady(m, 'exogenize', @auto, 'endogenize', 'alp', 'display', 'none');

m4 = m;
m4.alp = m3.alp;
m4 = steady(m4, 'display', 'none');
...
m.k = 0.95*m.k;
m1 = steady(m, 'exogenize', @auto, 'endogenize', @auto, 'display', 'none');
m2 = steady(m, 'exogenize', 'y,k', 'endogenize', @auto, 'display', 'none');
m3 = steady(m, 'exogenize', {'k','y'}, 'endogenize', @auto, 'display', 'none');
compareModels(m1, m2);
compareModels(m1, m3);
...
m1 = m;
m1.k = 0.95*m1.k;
m1 = steady(m1, 'exogenize', 'k', 'endogenize', @auto, 'display', 'none');
m2 = m;
m2.del = m1.del;
m2 = steady(m2, 'display', 'none');
compareModels(m1, m2);
...
m.k = 0.95*m.k;
m1 = steady(m, 'exogenize', @auto, 'endogenize', @auto, 'display', 'none');
m2 = steady(m, 'exogenize', @auto, 'endogenize', 'del,alp', 'display', 'none');
m3 = steady(m, 'exogenize', @auto, 'endogenize', {'alp','del'}, 'display', 'none');
